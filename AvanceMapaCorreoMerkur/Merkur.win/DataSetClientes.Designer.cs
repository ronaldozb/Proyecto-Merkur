...
namespace Merkur.win {
    ...
    public partial class DataSetClientes : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClienteRow AddClienteRow(string Cedula, string Nombres, string Apellidos, byte[] Foto) {
...
namespace Merkur.win.DataSetClientesTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([Cedula], [Nombres], [Apellidos], [Foto]) VALUES (@C" +
                "edula, @Nombres, @Apellidos, @Foto);\r\nSELECT Id, Cedula, Nombres, Apellidos, Fot" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Cliente] SET [Cedula] = @Cedula, [Nombres] = @Nombres, [Apellidos] " +
                "= @Apellidos, [Foto] = @Foto WHERE (([Id] = @Original_Id));\r\nSELECT Id, Cedula, " +
                "Nombres, Apellidos, Foto FROM Cliente WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Cedula, Nombres, Apellidos, Foto FROM dbo.Cliente";
        ...
        public virtual int Insert(string Cedula, string Nombres, string Apellidos, byte[] Foto) {
            if ((Cedula == null)) {
        ...
        public virtual int Update(string Cedula, string Nombres, string Apellidos, byte[] Foto, int Original_Id, int Id) {
            if ((Cedula == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Cedula, string Nombres, string Apellidos, byte[] Foto, int Original_Id) {
            return this.Update(Cedula, Nombres, Apellidos, Foto, Original_Id, Original_Id);
        }
    }
